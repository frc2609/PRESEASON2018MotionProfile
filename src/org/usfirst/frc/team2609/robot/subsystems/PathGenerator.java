...
public class PathGenerator {
	Trajectory.Config configFast = new Trajectory.Config(Trajectory.FitMethod.HERMITE_CUBIC, Trajectory.Config.SAMPLES_FAST, 0.01, 6, 4, 120); 
...
//            new Waypoint(107/12, 57.5/12, Pathfinder.d2r(60)) // HITTING THE WALL IN HAMILTON
            new Waypoint(8, 6, Pathfinder.d2r(60)) // HITTING THE WALL IN HAMILTON
	};
