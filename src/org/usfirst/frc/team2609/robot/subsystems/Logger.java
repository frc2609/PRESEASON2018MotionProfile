...
//	        	this.writer.write(String.format(",%d", new java.util.Date().getTime()));
	            ...
	            this.writer.write(String.format(",%d", RobotMap.left1.getEncVelocity()));
	            this.writer.write(String.format(",%d", RobotMap.right1.getEncVelocity()));
	            this.writer.write(String.format(",%.3f", RobotMap.left1.getOutputVoltage()));
	            this.writer.write(String.format(",%.3f", RobotMap.left2.getOutputVoltage()));
	            this.writer.write(String.format(",%.3f", RobotMap.right1.getOutputVoltage()));
	            this.writer.write(String.format(",%.3f", RobotMap.right2.getOutputVoltage()));
...
//        	this.writer.write(String.format(",%d", new java.util.Date().getTime()));
            this.writer.write(String.format(",%.3f", RobotMap.left1.getPosition()));
            this.writer.write(String.format(",%.3f", RobotMap.right1.getPosition()));
            this.writer.write(String.format(",%.3f", RobotMap.left1.getEncVelocity()));
            this.writer.write(String.format(",%.3f", RobotMap.right1.getEncVelocity()));
